...
const Sales = ({systemData}) => { 	
	...
	let {products, productsLoading, records, recordsLoading, stores, userData } = systemData;
	...
	const handleSubmit = async () => {
		...
		try {
			...
			let newStore = stores.docs.filter(x=> x.id === userData.userStore)[0];
			...
			<Card>
				...
				>
					<div className="d-md-flex justify-content-md-between">
						<div className="">
							<h2 className="mb-1 font-weight-semibold">Wastage damaged Form</h2>
						</div>
