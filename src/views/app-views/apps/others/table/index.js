				...
				render: (_, elm) => (
					<div className="text-right">
						<Tooltip title="View Comments">
							<Button type="primary" className="mr-2" icon={<EyeOutlined />} onClick={() => {showInvoice(elm.data())}} size="small"/>
						</Tooltip>
					</div>
				)
			}
				...
				render: (_,elm) => (
					<div className="text-right">
						<Tooltip title="Add Payment">
							<Button className="mr-2" onClick={() => {setActiveCustomer(elm)}} size="small">Add Payment</Button>
						</Tooltip>
