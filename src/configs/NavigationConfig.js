...
const appsNavTree = [{
  ...
  submenu: [
    ...
    {
      key: 'apps-expenses',
      path: `${APP_PREFIX_PATH}/apps/expenses`,
    ...
    {
      key: 'apps-credits',
      path: `${APP_PREFIX_PATH}/apps/credits`,
      title: 'sidenav.apps.credits',
      icon: CalculatorOutlined ,
      breadcrumb: false,
      submenu: [
        {
          key: 'apps-credits-clients',
          path: `${APP_PREFIX_PATH}/apps/credits`,
          title: 'sidenav.apps.credits.clients',
          icon: '',
          breadcrumb: false,
          submenu: []
        },
        {
          key: 'apps-credits-suppliers',
          path: `${APP_PREFIX_PATH}/apps/outStanding`,
          title: 'sidenav.apps.credits.suppliers',
          icon: '',
          breadcrumb: false,
          submenu: []
        },
        {
          key: 'apps-credits-other-expenses',
          path: `${APP_PREFIX_PATH}/apps/others`,
          title: 'sidenav.apps.credits.other-expenses',
          icon: '',
          breadcrumb: false,
          submenu: []
        },
    ...
    {
      key: 'apps-purchases',
      path: `${APP_PREFIX_PATH}/apps/purchases/list`,
      title: 'sidenav.apps.purchases',
    ...
    },
    {
      ...
      title: 'sidenav.apps.suppliers',
      icon: ContactsOutlined,
      breadcrumb: false,
      submenu: []
    },
    {
      key: 'apps-shops-quantity',
      path: `${APP_PREFIX_PATH}/apps/shopQuantity`,
      title: 'sidenav.apps.shops-quantity',
    ...
    {
      key: 'apps-refunds',
      path: `${APP_PREFIX_PATH}/apps/refunds`,
      title: 'sidenav.apps.refunds',
      icon: AlertOutlined,
      breadcrumb: false,
      submenu: []
    },
    {
      key: 'apps-damaged',
      path: `${APP_PREFIX_PATH}/apps/damaged`,
      title: 'sidenav.apps.damaged',
    ...
    },
    {
      ...
      title: 'sidenav.apps.report',
      icon: AuditOutlined,
      breadcrumb: false,
      submenu: [
        {
          key: 'apps-report-daily',
          path: `${APP_PREFIX_PATH}/apps/dailyReport`,
          title: 'sidenav.apps.report.daily',
          icon: '',
          breadcrumb: false,
          submenu: []
        },
        {
          key: 'apps-report-product',
          path: `${APP_PREFIX_PATH}/apps/report`,
          title: 'sidenav.apps.report.product',
          icon: '',
          breadcrumb: false,
          submenu: []
        },
    ...
    {
      key: 'apps-brandCategory',
      path: `${APP_PREFIX_PATH}/apps/extra`,
      title: 'sidenav.apps.brandCategory',
    ...
    {
      key: 'apps-stores',
      path: `${APP_PREFIX_PATH}/apps/stores`,
      title: 'sidenav.apps.stores',
      icon: ShopOutlined,
      breadcrumb: false,
      submenu: []
    },
    {
      key: 'apps-system',
      path: `${APP_PREFIX_PATH}/apps/setting`,
      title: 'sidenav.apps.system-settings',
      icon: ControlOutlined,
      breadcrumb: false,
      submenu: []
    },
...
const userNavTree = [{
  ...
  submenu: [
    ...
    {
      key: 'apps-shop-quantity',
      path: `${APP_PREFIX_PATH}/apps/shop`,
      title: 'sidenav.apps.shop-quantity',
    ...
    },
    {
      ...
      submenu: [
        {
          key: 'apps-report-sales',
          path: `${APP_PREFIX_PATH}/apps/salesReport`,
          title: 'sidenav.apps.report.sales',
          icon: '',
          breadcrumb: false,
          submenu: []
        },
