...
const appsNavTree = [{
  ...
  submenu: [
    ...
    {
      key: 'apps-quantity-in-hand',
      path: `${APP_PREFIX_PATH}/apps/quantity`,
      title: 'sidenav.apps.quantity-in-hand',
    ...
    {
      key: 'apps-refill',
      path: `${APP_PREFIX_PATH}/apps/refill`,
      title: 'sidenav.apps.refill',
